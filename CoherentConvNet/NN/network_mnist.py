...
def conv(image, label, params, gamma, validation = False):
    ...
    conv3 = convolutionComplexBatch(nonlin2, f3, s=p) # second convolution operation
    ...
    db3 = np.sum(dpool.real * dbr + 1j * dpool.imag * dbi, axis=(2,3))
    ...
    db2 = np.sum(dnonlin2.real * dbr + 1j * dnonlin2.imag * dbi, axis=(2,3))
    ...
    db1 = np.sum(dnonlin1.real * dbr + 1j * dnonlin1.imag * dbi, axis=(2,3))
...
def adamGD(batch, num_classes, lr, dim, n_c, beta1, beta2, params, adam_weights, adam_bias, cost, gamma):
    '''
    ...
    [v1, v2, v3, v4, v5, s1, s2, s3, s4, s5] = adam_weights
    [bv1, bv2, bv3, bv4, bv5, bs1, bs2, bs3, bs4, bs5] = adam_bias
    ...
    adam_weights = [v1, v2, v3, v4, v5, s1, s2, s3, s4, s5]
    adam_bias = [bv1, bv2, bv3, bv4, bv5, bs1, bs2, bs3, bs4, bs5]
    
    return params, adam_weights, adam_bias, cost, nl1, nl2, nl3, nl4
...
def train(num_classes = 10, lr = 0.01, beta1 = 0.95, beta2 = 0.99,
    ...
    # training data
    X, y_dash, X_val, y_dash_val = mnist_training_and_validation_set()
