...
if __name__ == '__main__':
    ...
    save_path = 'adamGD_SoftmaxCross_8Gamma_lr01_bias4b_CoherentNet_8_8f5_8p2_128_mnistDataset_NLdata_try0.pkl'
    gamma = 8
